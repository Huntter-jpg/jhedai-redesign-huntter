                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                    {solutions.map((sol, k) => (
                      <motion.div
                        ...
                        className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-jhedai-neutral/20 hover:border-jhedai-secondary/30 transition-all duration-300 overflow-hidden"
                      >
                        <div
